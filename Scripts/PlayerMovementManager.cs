...
public class PlayerMovementManager : MonoBehaviour
{
    ...
    void OnCollisionStay(Collision collision)
    {
        ...
        if (playerStandingOnMovableGround && (collision.gameObject.layer == 7 || collision.gameObject.layer == 8))
        {
            ...
            {
                playerRigidbody.AddForce(collision.gameObject.GetComponent<Rigidbody>().linearVelocity * theMoveMultiplier * Time.fixedDeltaTime * 1.333f, ForceMode.Acceleration); // Yes, I found the 1.333f number by trying.
            }
            else
            {
                playerRigidbody.AddForce(collision.gameObject.GetComponent<Rigidbody>().linearVelocity * theMoveMultiplier * airMoveMultiplier * Time.fixedDeltaTime / 49.96f, ForceMode.Acceleration); // Yes, I also found the 49.96f number by trying.
            }
        }
    }
