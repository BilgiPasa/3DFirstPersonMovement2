...
public class PlayerMovementManager : MonoBehaviour
{
    ...
    void GroundedCheckAndFallingCheckAndBouncyJumpAndCoyoteTimeAndFallDamage()
    {
        ...
        {
            groundedForAll = Physics.CheckSphere(playerTransform.position - new Vector3(0, crouchHeight / 2, 0), groundedSphereRadius, normalLayer | bouncyLayer | movableNormalLayer);
